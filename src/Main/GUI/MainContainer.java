...
public class MainContainer extends JLayeredPane {
    ...
    public MainContainer(Player player, List<Enemy> enemies, Inventory inventory, List<Potion> potions) {
        ...
        add(enemiesView, Integer.valueOf(2));
        add(hudView, Integer.valueOf(3));
